        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentNumber = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_TenantId_BranchId_AppointmentNumber",
                table: "Appointments",
                columns: new[] { "TenantId", "BranchId", "AppointmentNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_TenantId_BranchId_CustomerNumber",
                table: "Customers",
                columns: new[] { "TenantId", "BranchId", "CustomerNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_TenantId_BranchId_InvoiceNumber",
                table: "Invoices",
                columns: new[] { "TenantId", "BranchId", "InvoiceNumber" },
                unique: true);
